export type WorkProject = {
  ...
  coverScreen?: string;
  coverScreens?: string[];
  coverDevice?: 'laptop' | 'phone' | 'phone-stack' | 'tablet' | 'freeform';
  coverAccent?: string;
  coverMotif?:
    | 'beauty'
    | 'procurement'
    ...
    | 'research-sharing'
    | 'research-coding';
  coverScreenFit?: 'cover' | 'contain';
  coverScreenPosition?: string;
  href: string;
};
...
export const productProjects: WorkProject[] = [
  {
    ...
    image: '/img/def-erp/def-erp-cover-v4.webp',
    imageFit: 'cover',
    imageScale: 1,
    imageTranslateY: '0%',
    imageBackground: '#f1f3f5',
    coverScreen: '/img/def-erp/dashboard-admin-v6.png',
    coverDevice: 'laptop',
    coverAccent: '#2274ff',
    coverMotif: 'beauty',
  ...
  },
  {
    ...
    description: 'Started from document checks. Ended with AI in the full purchasing workflow.',
    image: '/img/procurement-agent/Procurement Agent.avif',
    imageFit: 'cover',
    imageScale: 1.68,
    imageTranslateY: '0%',
    imageBackground: '#161616',
    coverScreen: '/img/procurement-agent/procurement-agent-workspace-cover.png',
    coverDevice: 'laptop',
    coverAccent: '#6c5ce7',
    coverScreenFit: 'contain',
    coverMotif: 'procurement',
  ...
  },
  {
    ...
    coverScreen: '/img/connectnova/connectnova-dashboard-cover.webp',
    coverDevice: 'laptop',
    coverAccent: '#1768e5',
    coverScreenFit: 'contain',
    coverMotif: 'recruiting',
  ...
  },
  {
    ...
    coverScreen: '/img/jobnova/jobnova-matched-jobs-cover.png',
    coverDevice: 'laptop',
    coverAccent: '#2553d8',
    coverMotif: 'job-search',
  ...
  },
  {
    ...
    image: '/img/MemQ.avif',
    coverScreen: '/img/MemQ/Home.PNG',
    coverScreens: ['/img/MemQ/Home.PNG', '/img/MemQ/Explore1.PNG', '/img/MemQ/AI1.PNG'],
    coverDevice: 'phone-stack',
    coverAccent: '#ff7557',
    coverMotif: 'learning',
    href: '/projects/memq',
  },
  {
    ...
    coverScreen: '/img/Beikemama/Beikemama.avif',
    coverDevice: 'freeform',
    coverAccent: '#ff6d74',
    coverScreenFit: 'contain',
    coverMotif: 'parenting',
  ...
  },
  {
    ...
    coverScreen: '/img/Mono/mono-cover-cutout.png',
    coverDevice: 'freeform',
    coverAccent: '#167f62',
    coverScreenFit: 'contain',
    coverMotif: 'finance',
  ...
  },
  {
    ...
    coverScreen: '/img/crackinterview/Standard%20Mode.avif',
    coverDevice: 'laptop',
    coverAccent: '#7657ff',
    coverMotif: 'interview',
  ...
  },
  {
    ...
    coverScreen: '/img/customer-service-system/Customer%20Support%20-%20Desktop.avif',
    coverDevice: 'laptop',
    coverAccent: '#198cd8',
    coverMotif: 'support',
  ...
  },
  {
    ...
    coverScreen: '/img/Milano%20Partecipa.avif',
    coverDevice: 'freeform',
    coverAccent: '#dc5247',
    coverScreenFit: 'contain',
    coverMotif: 'civic',
...
export const researchProjects: WorkProject[] = [
  {
    ...
    coverScreen: '/img/walnut-coding-research-cover-v3.webp',
    coverDevice: 'tablet',
    coverAccent: '#c9893f',
    coverMotif: 'research-coding',
  ...
  },
  {
    ...
    coverScreen: '/img/walnut-sharing-research-cover-v3.webp',
    coverDevice: 'tablet',
    coverAccent: '#c66f5a',
    coverMotif: 'research-sharing',
