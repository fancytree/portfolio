  ...
  return (
    <div style={{ marginTop: '52px' }}>
      ...
      <div className="grid grid-cols-1 gap-5 md:grid-cols-[minmax(0,3.62fr)_minmax(0,1fr)]">
        <div style={{ alignItems: 'center', aspectRatio: '189 / 107', background: '#FFFFFF', border: '8px solid #E5E7EB', borderRadius: '20px', display: 'flex', justifyContent: 'center', overflow: 'hidden' }}>
        ...
        <div style={{ alignItems: 'center', aspectRatio: '136 / 279', background: '#FFFFFF', border: '8px solid #E5E7EB', borderRadius: '20px', display: 'flex', justifyContent: 'center', overflow: 'hidden' }}>
...
function ExistingImage({ src, alt, contain = false, frameless = false }: { src: string; alt: string; contain?: boolean; frameless?: boolean }) {
  return (
    <div style={{ alignItems: 'center', background: frameless ? 'transparent' : '#FFFFFF', border: frameless ? 0 : '1px solid rgba(10,10,10,0.1)', display: 'flex', justifyContent: 'center', overflow: 'hidden', padding: frameless ? 0 : '12px' }}>
