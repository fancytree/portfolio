    ...
    <div className="mei-project-page w-full min-w-0" style={{ backgroundColor: '#FFFFFF' }}>
      ...
      >
        <ScrollAnimatedSection>
          <div style={{ maxWidth: CASE_STUDY_CONTENT_WIDTH, margin: '0 auto', width: '100%' }}>
      ...
      >
        <ScrollAnimatedSection>
          <div style={{ maxWidth: CASE_STUDY_CONTENT_WIDTH, margin: '0 auto' }}>
            ...
            <div style={{ marginTop: '56px', maxWidth: CASE_STUDY_CONTENT_WIDTH }}>
              <h3
                style={{
                  ...fontStyle,
                  ...textStyle.h3Medium,
      ...
      >
        ...
        <div
          style={{
            maxWidth: CASE_STUDY_CONTENT_WIDTH,
            margin: '0 auto',
            marginBottom: '32px',
          }}
        >
      ...
      >
        <ScrollAnimatedSection>
          <div style={{ maxWidth: CASE_STUDY_CONTENT_WIDTH, margin: '0 auto', padding: '0 24px' }}>
