...
function ResumeAnalyzingHero() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="jobnova-orbit-rotator" style={{ position: 'absolute', left: 79, top: 79, width: 0, height: 0 }}>
          <div
            className="jobnova-orbit-counter"
            style={{
              ...badge,
              left: -66,
              top: 36,
...
function AnalyzingStatusLineWithDots({ line }: { line: string }) {
  ...
  return (
    <>
      {base}
      <span className="jobnova-dot-wave" aria-hidden>
        <span>.</span>
        <span>.</span>
        <span>.</span>
      </span>
...
export default function JobnovaPageDesignMockup() {
  ...
  return (
    ...
    >
      ...
      <style>
        {`
@keyframes jobnova-orbit-spin {
  from { transform: rotate(0deg); }
  to { transform: rotate(360deg); }
}
@keyframes jobnova-orbit-counter {
  from { transform: translate(-50%, -50%) rotate(0deg); }
  to { transform: translate(-50%, -50%) rotate(-360deg); }
}
.jobnova-orbit-rotator {
  transform-origin: 0 0;
  animation: jobnova-orbit-spin ${ANALYZING_ORBIT_PERIOD_MS}ms linear infinite;
}
.jobnova-orbit-counter {
  animation: jobnova-orbit-counter ${ANALYZING_ORBIT_PERIOD_MS}ms linear infinite;
}
@keyframes jobnova-analyzing-status-step {
  from {
    opacity: 0;
...
.jobnova-analyzing-status-step {
  animation: jobnova-analyzing-status-step 0.38s ease-out both;
}
@keyframes jobnova-dot-wave {
  0%,
  100% {
    opacity: 0.2;
    transform: translateY(0);
...
.jobnova-dot-wave span {
  display: inline-block;
  min-width: 0.22em;
  animation: jobnova-dot-wave 0.9s ease-in-out infinite;
}
.jobnova-dot-wave span:nth-child(2) {
  animation-delay: 0.15s;
}
.jobnova-dot-wave span:nth-child(3) {
  animation-delay: 0.3s;
}
/* 步骤切换淡入 */
@keyframes jobnova-step-fade-in {
  from {
    opacity: 0;
...
.jobnova-step-fade-in {
  animation: jobnova-step-fade-in 0.28s cubic-bezier(0.2, 0.8, 0.3, 1) both;
}
@media (prefers-reduced-motion: reduce) {
  ...
  .jobnova-step0-gradient-slot-in,
  .jobnova-step0-pills-fade,
  .jobnova-step0-cluster-shift,
  .jobnova-step0-positions-slab-in,
  .jobnova-step-fade-in {
    animation: none !important;
    opacity: 1 !important;
    transform: none !important;
...
@keyframes jobnova-step0-gradient-to-line {
  from {
    opacity: 0;
...
.jobnova-step0-gradient-slot-in {
  display: inline-block;
  animation: jobnova-step0-gradient-to-line 0.48s ease-out both;
}
@keyframes jobnova-step0-pills-hide {
  from { opacity: 1; }
  to   { opacity: 0; }
}
.jobnova-step0-pills-fade {
  animation: jobnova-step0-pills-hide 0.25s ease-out forwards;
  pointer-events: none;
}
...
@keyframes jobnova-step0-slab-up {
  from {
    opacity: 0;
    transform: translateY(14px);
  }
...
.jobnova-step0-positions-slab-in {
  animation: jobnova-step0-slab-up 0.36s cubic-bezier(0.2, 0.8, 0.3, 1) both;
}
        `}
      </style>
      <div
      ...
      >
        <div style={{ position: 'relative', width: 185, height: 40, maxWidth: '45vw' }}>
          <Image src={ASSET.logo} alt="JobNova" fill sizes="185px" style={{ objectFit: 'contain', objectPosition: 'left' }} />
        </div>
        <button
          type="button"
          onClick={resetWizard}
      ...
      >
        <div
          key={step}
          className="jobnova-step-fade-in"
          style={{
            display: 'flex',
            flexDirection: 'column',
            justifyContent: 'space-between',
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', width: '100%' }}>
              {step0Phase === 0 ? (
                <>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', width: '100%' }}>
                      ...
                      >
                        ...
                        {!areaOfInterest ? (
                          ...
                          <span
                            className={step0AreaIntro === 'toLine' ? 'jobnova-step0-gradient-slot-in' : undefined}
                            style={{
                              ...gradientLinkStyle,
                              cursor: 'default',
                            }}
                      ...
                      {!areaOfInterest ? (
                        ...
                        <div
                          className="jobnova-step0-pills-fade"
                  ...
                  {step0AreaIntro === 'showPositions' ? (
                    <div
                      className="jobnova-step0-positions-slab-in"
                    ...
                    <>
                      ...
                      >
                        ...
                        {!experienceLevel ? (
                          ...
                          <span
                            className={step0ExperienceIntro === 'toLine' ? 'jobnova-step0-gradient-slot-in' : undefined}
                            style={{
                              ...gradientLinkStyle,
                  ...
                  {step0Phase === 3 ? (
                    <>
                      ...
                      >
                        ...
                        >
                          I would like to receive emails from Jobnova.ai
                        </span>
                        {!emailFrequency ? (
                          <InlineUnderline />
                        ) : step0EmailIntro !== 'idle' ? (
                          <span
                            className={step0EmailIntro === 'toLine' ? 'jobnova-step0-gradient-slot-in' : undefined}
                            style={{
                              ...gradientLinkStyle,
          ...
          <>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', width: '100%' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', width: '100%' }}>
                    ...
                    >
                      ...
                      {!step1EmploymentType ? (
                        ...
                        <span
                          className={step1EmploymentIntro === 'toLine' ? 'jobnova-step0-gradient-slot-in' : undefined}
                          style={{
                            ...gradientLinkStyle,
                            backgroundImage: 'linear-gradient(103deg, rgb(167, 237, 3) 7.76%, rgb(208, 235, 5) 98.83%)',
                            cursor: 'default',
              ...
              {(step1Phase >= 1 || step1EmploymentIntro === 'showLocation') && step1EmploymentType ? (
                <div
                  className={step1EmploymentIntro === 'showLocation' ? 'jobnova-step0-positions-slab-in' : undefined}
                  style={{ display: 'flex', flexDirection: 'column', gap: '24px', width: '100%' }}
                >
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', width: '100%' }}>
                  ...
                  >
                    ...
                    {!visaPreference ? (
                      ...
                      <span
                        className={step1VisaIntro === 'toLine' ? 'jobnova-step0-gradient-slot-in' : undefined}
                        style={{
                          ...gradientLinkStyle,
              ...
              >
                ...
                >
                  ...
                  <p
                    ...
                    className="jobnova-analyzing-status-step"
                    aria-live="polite"
                    style={{
                      ...font,
                      margin: 0,
