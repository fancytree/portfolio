 ...
 * a neutral exchange stroke. Sits directly on the white section, no container fill.
 *
 * The legend is stacked vertically under the DEMAND SIDE zone rather than as a
 * bottom strip. It fills otherwise-empty canvas and collides with nothing.
 */
    ...
    <div className="overflow-x-auto">
      <svg viewBox="0 0 1200 720" role="img" aria-labelledby="def-ecosystem-title def-ecosystem-desc"
            ...
            <defs>
              ...
              <marker id="arrow-accent" markerWidth="8" markerHeight="6" refX="7" refY="3" orient="auto"><polygon points="0 0, 8 3, 0 6" fill="#2155e8"/></marker>
            ...
            <rect x="32" y="324" width="24" height="16" rx="4" fill="#e9eef8" stroke="#2155e8" strokeWidth="1"/>
            <text x="68" y="336" fill="#555555" fontSize="12" fontFamily={fontFamily.mono}>Focus of this case study</text>
            <rect x="32" y="364" width="24" height="16" rx="4" fill="#ffffff" stroke="#161616" strokeWidth="1"/>
            <text x="68" y="376" fill="#555555" fontSize="12" fontFamily={fontFamily.mono}>Platform module</text>
            <rect x="32" y="404" width="24" height="16" rx="4" fill="rgba(22,22,22,0.03)" stroke="rgba(22,22,22,0.30)" strokeWidth="1"/>
            <text x="68" y="416" fill="#555555" fontSize="12" fontFamily={fontFamily.mono}>External party</text>
            <line x1="32" y1="452" x2="56" y2="452" stroke="#555555" strokeWidth="1.6"/>
            <text x="68" y="456" fill="#555555" fontSize="12" fontFamily={fontFamily.mono}>Internal flow</text>
            <line x1="32" y1="492" x2="56" y2="492" stroke="#64748b" strokeWidth="1.6"/>
            <text x="68" y="496" fill="#555555" fontSize="12" fontFamily={fontFamily.mono}>External exchange</text>
          </svg>
    </div>
  );
}
