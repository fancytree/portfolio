...
/**
 * Business ecosystem diagram, adapted from the Procurement Agent case study's
 * section 01 diagram for the platform-wide DEF ERP case study.
 *
 * No single module is highlighted as "focus" here, unlike the procurement-specific
  ...
  return (
    <div className="overflow-x-auto">
      <svg viewBox="0 0 1200 720" role="img" aria-labelledby="def-ecosystem-title def-ecosystem-desc"
            ...
            {/* ===== ARROWS (before boxes) ===== */}
            {/* 1. Customer -> WeChat Store (label removed: obvious from layout) */}
            <line x1="192" y1="168" x2="240" y2="168" stroke="#555555" strokeWidth="1.2" markerEnd="url(#arrow)"/>

            {/* 2. WeChat Store -> Sales Order */}
            <line x1="400" y1="168" x2="496" y2="168" stroke="#64748b" strokeWidth="1.2" markerEnd="url(#arrow-link)"/>
            <rect x="432" y="148" width="32" height="12" rx="2" fill="#ffffff"/>
            <text x="448" y="156" fill="#777777" fontSize="8" fontFamily={fontFamily.mono} textAnchor="middle" letterSpacing="0.06em">SYNC</text>

            {/* 3. Sales Order -> Inventory */}
            <line x1="560" y1="208" x2="560" y2="304" stroke="#555555" strokeWidth="1.2" markerEnd="url(#arrow)"/>
            <rect x="568" y="248" width="48" height="12" rx="2" fill="#ffffff"/>
            <text x="592" y="256" fill="#777777" fontSize="8" fontFamily={fontFamily.mono} textAnchor="middle" letterSpacing="0.06em">DEMAND</text>

            {/* 4. Inventory -> Procurement */}
            <line x1="560" y1="384" x2="560" y2="480" stroke="#555555" strokeWidth="1.2" markerEnd="url(#arrow)"/>
            <rect x="496" y="424" width="56" height="12" rx="2" fill="#ffffff"/>
            <text x="524" y="432" fill="#777777" fontSize="8" fontFamily={fontFamily.mono} textAnchor="middle" letterSpacing="0.06em">STOCK GAP</text>

            {/* 5. Procurement -> Supplier (human gate) */}
            <path d="M 576,560 V 656 Q 576,664 584,664 H 976" fill="none" stroke="#64748b" strokeWidth="1.2" markerEnd="url(#arrow-link)"/>
            <rect x="744" y="644" width="64" height="12" rx="2" fill="#ffffff"/>
            <text x="776" y="652" fill="#777777" fontSize="8" fontFamily={fontFamily.mono} textAnchor="middle" letterSpacing="0.06em">HUMAN GATE</text>

            {/* 6. Supplier -> Receiving */}
            <path d="M 1056,624 V 528 Q 1056,520 1048,520 H 896" fill="none" stroke="#64748b" strokeWidth="1.2" markerEnd="url(#arrow-link)"/>
            <rect x="944" y="500" width="64" height="12" rx="2" fill="#ffffff"/>
            <text x="976" y="508" fill="#777777" fontSize="8" fontFamily={fontFamily.mono} textAnchor="middle" letterSpacing="0.06em">DDT · GOODS</text>

            {/* 7. Receiving -> Inventory (the loop closes) */}
            <path d="M 736,504 H 704 Q 696,504 696,496 V 352 Q 696,344 688,344 H 656" fill="none" stroke="#555555" strokeWidth="1.2" markerEnd="url(#arrow)"/>
            <rect x="608" y="440" width="80" height="12" rx="2" fill="#ffffff"/>
            <text x="648" y="448" fill="#777777" fontSize="8" fontFamily={fontFamily.mono} textAnchor="middle" letterSpacing="0.06em">STOCK-IN ±VAR</text>

            {/* 8. Receiving -> Finance */}
            <line x1="816" y1="480" x2="816" y2="384" stroke="#555555" strokeWidth="1.2" markerEnd="url(#arrow)"/>
            <rect x="824" y="424" width="48" height="12" rx="2" fill="#ffffff"/>
            <text x="848" y="432" fill="#777777" fontSize="8" fontFamily={fontFamily.mono} textAnchor="middle" letterSpacing="0.06em">INVOICE</text>
            ...
            <rect x="496" y="480" width="160" height="80" rx={caseRadiusPx.sm} fill="#ffffff" stroke="#161616" strokeWidth="1"/>
            <rect x="508" y="488" width="32" height="12" rx="2" fill="transparent" stroke="rgba(22,22,22,0.40)" strokeWidth="0.8"/>
            <text x="524" y="496" fill="rgba(22,22,22,0.70)" fontSize="7" fontFamily={fontFamily.mono} textAnchor="middle" letterSpacing="0.08em">CORE</text>
            ...
            <text x="1056" y="688" fill="#555555" fontSize="9" fontFamily={fontFamily.mono} textAnchor="middle">moq · lead time</text>

            {/* ===== LEGEND: vertical, under the DEMAND SIDE zone ===== */}
            <line x1="32" y1="272" x2="432" y2="272" stroke="rgba(22,22,22,0.10)" strokeWidth="0.8"/>
            <text x="32" y="296" fill="#555555" fontSize="8" fontFamily={fontFamily.mono} letterSpacing="0.14em">LEGEND</text>
            <rect x="32" y="324" width="24" height="16" rx="4" fill="#ffffff" stroke="#161616" strokeWidth="1"/>
            <text x="68" y="336" fill="#555555" fontSize="12" fontFamily={fontFamily.mono}>Platform module</text>
            <rect x="32" y="364" width="24" height="16" rx="4" fill="rgba(22,22,22,0.03)" stroke="rgba(22,22,22,0.30)" strokeWidth="1"/>
            <text x="68" y="376" fill="#555555" fontSize="12" fontFamily={fontFamily.mono}>External party</text>
            <line x1="32" y1="412" x2="56" y2="412" stroke="#555555" strokeWidth="1.6"/>
            <text x="68" y="416" fill="#555555" fontSize="12" fontFamily={fontFamily.mono}>Internal flow</text>
            <line x1="32" y1="452" x2="56" y2="452" stroke="#64748b" strokeWidth="1.6"/>
            <text x="68" y="456" fill="#555555" fontSize="12" fontFamily={fontFamily.mono}>External exchange</text>
          </svg>
    </div>
  );
}
