...
import { dmMono, geistMono, geistSans, inter, nunito } from "./fonts";
import "./globals.css";
...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${geistSans.variable} ${geistMono.variable} ${nunito.variable} ${inter.variable} ${dmMono.variable}`}
    >
